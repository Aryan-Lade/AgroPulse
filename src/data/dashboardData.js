/**
 * dashboardData.js — all dummy data feeding the dashboard.
 * No backend: everything the UI renders comes from this module,
 * shaped the way a future API layer would return it.
 */
...
/* ------------------------------------ Charts -------------------------------------- */
// Line — disease detections per month
...
// Bar — soil nutrient levels vs optimal
...
// Pie — crop distribution by area (ha)
...
// Area — rainfall prediction (mm, next 7 days)
